...
public class Notification {
    ...
    public Notification(Long id, String title, String message, NotificationType notificationType, String status, LocalDateTime createdAt) {
        this.id = id;
        this.title = title;
    ...
    public static class NotificationBuilder {
        ...
        public Notification build() {
            return new Notification(id, title, message, notificationType, status, createdAt);
        }
    }
}
