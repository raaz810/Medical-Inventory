...
public class Medicine {
    ...
    public Medicine(Long id, String medicineCode, String medicineName, String genericName, String category, String manufacturer, BigDecimal unitPrice, BigDecimal sellingPrice, String batchNumber, String description, Supplier supplier, LocalDateTime createdAt) {
        this.id = id;
    ...
    public static class MedicineBuilder {
        ...
        public Medicine build() {
            return new Medicine(id, medicineCode, medicineName, genericName, category, manufacturer, unitPrice, sellingPrice, batchNumber, description, supplier, createdAt);
        }
    }
}
